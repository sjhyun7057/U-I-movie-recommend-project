        ...
        <div class="movie-title">
          <div class="select-box">
            ...
            <select class="select" name="movie-title" id="movie-title" @change="getTitle">
              ...
              <option v-for="movie in profile.favorite_movies" :key="movie.id" :value="movie.id">{{ movie.title }}</option>
            </select>
          </div>
        </div>
...
export default {
  ...
  computed:{
    ...mapGetters(['genreMovie', 'navState', 'profile'])
  },
  methods: {
    ...mapActions(['articleCreate', 'navToggle']),
    moveToBack () {
